...
<h1>N.B.</h1>
<h2>Data Source</h2>
This data is refreshed by a weekly cronjob that scrapes a report generated by tt.revacom.com.
The scraper currently only infers the dates of the packages from the dates it requests the report for.
This is why there can be multiple individual data points clustered in a vertical line for the same date.
<h2>Assumptions</h2>
